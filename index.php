...
?>
    <div class="main" id="main">
        <!-- Main Section-->
        <div class="hero-section app-hero" style="background-image: url(sky.jpg);">
            <div class="container mt-5">
                <div class="hero-content app-hero-content text-center mt-5">
                    ...
                    <div class="row justify-content-md-center mt-5">
                        <div class="col-md-12">
                            ...
                            <br class="d-block d-md-none">
                            <a class="btn btn-primary btn-lg" style="margin-top: 20px"
                               href="#">Apply to join</a>
                            <div class="text-muted" class="text-muted" style="margin-top: 10px">It takes only 5 minutes</div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.2s">
                                            <div class="services-icon">
                                                <img class="lazy" src="https://d383au3bye3rv1.cloudfront.net/static/images/optimized/feature_icon_2.png"
                                                     height="60" width="60" alt="Service"/>
                                            </div>
                                            <div class="services-description mt-4">
